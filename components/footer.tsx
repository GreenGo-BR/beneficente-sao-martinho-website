      ...
      <div className="container mx-auto px-4 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="space-y-4">
            <Image src="/logo-sao-martinho.png" alt="Logotipo do Instituto São Martinho - organização social com 39 anos de atuação em projetos para crianças" width={180} height={60} className="h-12 w-auto" />
